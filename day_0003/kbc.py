...
print("Here is a chance to WIN BIG amount of 15000/- Rs.")
...
while True:
 ...
 try:
  if(play not in play_tuple):
   raise ValueError("Enter correct option 'Yes' or 'No'...!!")
  break
 except ValueError:
...
ql=["Q1. Python file extension is: A. .pt B. .py C. .pyt D. .python",
